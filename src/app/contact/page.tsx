  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-100">
      ...
      <Navigation
        ...
        title="Contact TripTogether"
        subtitle="We're here to help! Reach out to us for any questions, support, or feedback about our services."
      />
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-10 w-96 h-96 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-20 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-8 leading-tight animate-fade-in-up animation-delay-200">
            Contact
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-blue-600 to-purple-600"> TripTogether</span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400 font-light">
            We're here to help! Reach out for <span className="font-semibold text-blue-600">questions</span>,
            <span className="font-semibold text-green-600"> support</span>, or
            <span className="font-semibold text-purple-600"> feedback</span> about our services.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mt-12 animate-fade-in-up animation-delay-600">
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
              ...
              <span className="text-sm font-medium text-gray-700">24/7 Phone Support</span>
            </div>
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
              ...
              <span className="text-sm font-medium text-gray-700">Quick Email Response</span>
            </div>
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
              ...
              <span className="text-sm font-medium text-gray-700">Expert Assistance</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">Available 24/7 for emergencies and bookings</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium">support@triptogether.in</p>
                    <p className="text-green-600 font-medium">bookings@triptogether.in</p>
                  </div>
                </div>
